...
namespace coordinator.Application
{
    ...
    public class JobPool : IJobPool
    {
        List<Job> jobs = new List<Job>
        {
            ...
            new Job { Difficulty = 0, Problem = "CALCULATE: 711 + 626", Solution = "1337" },
            ...
            new Job { Difficulty = 0, Problem = "CALCULATE: 4 / 3", Solution = "1.333" },
            new Job { Difficulty = 0, Problem = "CALCULATE: 12 * 6", Solution = "72" },
            new Job { Difficulty = 0, Problem = "CALCULATE: 11 * 11", Solution = "121" },
            new Job { Difficulty = 0, Problem = "CALCULATE: 64 / 8", Solution = "8" },
            new Job { Difficulty = 0, Problem = "CALCULATE: 34 * 1", Solution = "34" },
            new Job { Difficulty = 0, Problem = "CALCULATE: 726 * 3.14", Solution = "2279.64" },
            new Job { Difficulty = 1, Problem = "CALCULATE: -4 * 5", Solution = "-20" },
            new Job { Difficulty = 1, Problem = "CALCULATE: 63 / -9", Solution = "-7" },
